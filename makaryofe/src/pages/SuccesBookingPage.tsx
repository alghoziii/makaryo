  ...
  return (
    <main className="relative mx-auto w-full max-w-[640px] overflow-x-hidden bg-white pb-[144px]">
      <div id="Background" className="absolute left-0 right-0 top-1 h-[228px]">
        <img src="/assets/images/backgrounds/orange.png" alt="image" className="h-[480px] w-full object-cover object-bottom" />
      </div>
      <section
        id="NavTop"
        ...
        <div className="flex">
          ...
          <div className="relative z-10 flex h-[25px] w-[60px] items-center">
            ...
            <div className="absolute left-0 top-0 z-10 -translate-x-1/2">
              <div className="flex flex-col items-center gap-[6px]">
                <div className="flex h-[25px] w-[25px] items-center justify-center rounded-full bg-white text-xs font-bold leading-[18px]">3</div>
      ...
      <div className="relative mt-[44px] px-5">
        <img src="/assets/images/icons/note-finished.svg" alt="icon" className="h-[70px] w-[70px] shrink-0" />
        <header className="mt-[19px] flex flex-col gap-[6px]">
          <h1 className="text-[26px] font-extrabold leading-[39px] text-white">Booking Finished</h1>
          <p className="leading-[30px] text-white">Kami akan memeriksa pembayaran Anda silahkan periksa status secara berkala</p>
        </header>
        <section id="BookingDetails" className="mt-[30px] flex flex-col gap-4 rounded-3xl border border-shujia-graylight bg-white px-[14px] py-[14px]">
          ...
          <div className="flex gap-[10px]">
            <img src="/assets/images/icons/penting-finished.svg" alt="icon" className="h-[40px] w-[40px] shrink-0" />
            <div>
              <p className="text-sm leading-[21px] text-shujia-gray">Penting Diingat:</p>
              <strong className="font-semibold">Simpan bukti pembayaran dan nomor booking untuk referensi di masa mendatang</strong>
            </div>
          </div>
        </section>
        <section id="Btn" className="mt-[54px] flex flex-col gap-[14px]">
          <Link to={`/`}>
            <p className="w-full rounded-full bg-shujia-orange py-[14px] text-center font-semibold text-white transition-all duration-300 hover:shadow-[0px_4px_10px_0px_#D04B1E80]">Order Service Again</p>
          </Link>
          <Link to={`/my-booking`}>
            <p className="w-full rounded-full bg-shujia-black py-[14px] text-center font-semibold text-white">View My Booking Details</p>
          </Link>
        </section>
      </div>
    </main>
